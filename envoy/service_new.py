...
def hello(service_number):
  return ('Hello cluster1 from behind Envoy (service {})! hostname: {} resolved'
...
def hello_external(service_number):
  resp = requests.get('http://13.233.184.121:7002/external_service/1')
  return ('Hello cluster1 from behind Envoy (service {})! hostname: {} resolved'
        'hostname: {}\nResponse : {}\n'.format(os.environ['SERVICE_NAME'], socket.gethostname(),
...
def external(service_number):
    return ('Hello cluster1 external call service :  from behind Envoy (service {})! hostname: {} resolved'
          'hostname: {}\n'.format(os.environ['SERVICE_NAME'], socket.gethostname(),
                                  socket.gethostbyname(socket.gethostname())))
